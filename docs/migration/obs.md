...
place it in the runtime's `lib/site-packages`; keep OBS process discovery,
WebSocket authentication and scene operations in that adapter. Do not load the
shared runtime into OBS's own plug-in Python.
